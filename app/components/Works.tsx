...
export default function Works() {
  ...
  const animate = useCallback(() => {
    setCur((c) => ({
      x: c.x + (pos.x - c.x) * 0.18,
      y: c.y + (pos.y - c.y) * 0.18,
    }));
  ...
  return (
    <section id="trabajos" style={{ padding: "60px 0 140px", position: "relative" }}>
      <div className="mx-auto px-10" style={{ maxWidth: "var(--maxw)" }}>
        ...
        >
          ...
          >
            Selección de proyectos web recientes. Pasa el cursor sobre cualquiera
        ...
        >
          {works.map((w) => (
            ...
            >
              ...
              <div className="flex flex-col items-end gap-1.5 text-right hidden md:flex">
                <span
                  style={{
                    fontFamily: "var(--font-jetbrains-mono), monospace",
                    fontSize: 10,
              ...
              <span
                className="grid place-items-center transition-all duration-300 group-hover:rotate-[-45deg]"
                style={{
                  width: 48,
                  height: 48,
                  borderRadius: "50%",
      ...
      <div
        ...
        style={{
          ...
          opacity: preview ? 1 : 0,
          boxShadow:
            "0 30px 70px -20px rgba(26,26,31,.45), 0 10px 30px -10px rgba(26,26,31,.25)",
          border: "1px solid var(--color-line-strong)",
      ...
      >
        {preview && (
          <div className="flex flex-col h-full">
            ...
            <div
              className="flex-1"
              style={{ background: shotStyles[preview.shot] }}
            />
          </div>
        )}
      </div>
